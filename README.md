...
Examples of my work can be found in these [repositories](https://github.com/adpatter?tab=repositories) and in the repositories of the [Educational Technology Collective](https://github.com/educational-technology-collective).
...
### [Port Agent](https://github.com/adpatter/port_agent)<sup><sup>`</TypeScript>` `</Node.js>`</sup></sup>
